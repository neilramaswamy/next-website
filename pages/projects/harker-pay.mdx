...
In the summer of 2017, I was thinking about ways in which to improve campus life at my highschool. I wondered whether I could make easier the way that students paid for items at the snack bar. At the time, to purchase something, students would write down their name and amount on a charge sheet. This system, unsurprisingly, led to incorrect charges and lots of manual data entry. My first idea was to get a barcode reader, hook it up to a laptop, and scan students' IDs when they wanted to buy item. However, I had absolutely no clue how something like that would work, so I approached HarkerDev: the student-run development team that I would soon join and build Harker Pay with.

<h3>The Design Process</h3>

We started with a basic idea: make payments better at our highschool. From there, we talked to many of the staff members involved with the payment system and gleaned some information about existing problems:
...
-   Charge Sheets
    ...
    -   I also wrote verification scripts that would worked in the opposite direction: using data from the generated Excel sheet, we'd verify that the data there matched up with the Database.
-   Parent control over charges
    -   I implemented the parts of our API that allowed parents to set caps on how much their children could spend every specified time interval (like, "$5 every week this month").
    -   Unfortunately, this never shipped because our school wasn't comfortable with us handling auth for parents.

Those are most of the technical aspects of the product that I worked on. This project wouldn't at all have been possible without the phenomenal Ryan, Rithvik, and David, so I'll let them take to their own blog posts to explain what wonderful parts of this product they implemented.

<h3>Conclusion</h3>

Harker Pay was the first project I worked on that had _real_ usage. It's a great feeling when your servers crash because too many people are trying to use your product. At some points, we had over 300 concurrent users all making payments (there was an ice-cream truck that day!). By the time I had graduated, Harker Pay had processed over a quarter million dollars. As Ryan, Rithvik, David, and I were all graduating, we passed down Harker Pay to the future generation of Harker Dev, who now maintain it themselves.
