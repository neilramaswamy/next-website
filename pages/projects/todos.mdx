...
-   Mind Control: hijack an EEG reader turn on the lights in your room just by concentrating hard!
-   Core chords: a simple tool to help you learn difficult Jazz chords.
-   Private WiFi: create a private WiFi network for yourself by proxying through your RasPi.
